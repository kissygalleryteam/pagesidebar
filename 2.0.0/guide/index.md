...
* 版本：2.0.0
* Docs：[http://kg.kissyui.com/pagesidebar/2.0.0/guide/main.html](http://kg.kissyui.com/pagesidebar/2.0.0/guide/main.html)
* demo：[http://kg.kissyui.com/pagesidebar/2.0.0/demo/index.html](http://kg.kissyui.com/pagesidebar/2.0.0/demo/index.html)
...
<div class="nav" id="J_Nav">
    ...
    <p><a href="#" class="J_PageNavigator" data-navigator='{"to":2.0.0}'>去Top:2.0.0px的位置</a></p>
</div>
```
